...
ts_water_temp_2022_gg$Date2022 <- as.Date(water_quality_2018_2022$Date_2022, format = "%d/%m/%Y")
ts_water_temp_2021_gg$Date2021 <- as.Date(water_quality_2018_2022$Date_2021, format = "%d/%m/%Y")
ts_water_temp_2020_gg$Date2020 <- as.Date(water_quality_2018_2022$Date_2020, format = "%d/%m/%Y")
ts_water_temp_2019_gg$Date2019 <- as.Date(water_quality_2018_2022$Date_2019, format = "%d/%m/%Y")
ts_water_temp_2018_gg$Date2018 <- as.Date(water_quality_2018_2022$Date_2018, format = "%d/%m/%Y")
...
# Create a list of plots
plot_list_1 <- list(ts_wt_2018, ts_wt_2019, ts_wt_2020, ts_wt_2021, ts_wt_2022, ts_wt_2023)
...
# Create a list of plots
plot_list_1 <- list(ts_wt_2018_monthly, ts_wt_2019_monthly, ts_wt_2020_monthly, ts_wt_2021_monthly, ts_wt_2022_monthly, ts_wt_2023_monthly)


# Combine all the plots and add legends
combined_plot_1 <- do.call(grid.arrange, c(plot_list_1, nrow = 4))
...
# Create a list of plots
plot_list_1 <- list(ts_EC_2018, ts_EC_2019, ts_EC_2020, ts_EC_2021, ts_EC_2022, ts_EC_2023)
...
# Create a list of plots
plot_list_1 <- list(ts_EC_2018_monthly, ts_EC_2019_monthly, ts_EC_2020_monthly, ts_EC_2021_monthly, ts_EC_2022_monthly, ts_EC_2023_monthly)
...
# Create a list of plots
plot_list_1 <- list(ts_depth2018, ts_depth2019, ts_depth2020, ts_depth2021, ts_depth2022, ts_depth2023)
...
# Create a list of plots
plot_list_1 <- list(ts_depth2018_monthly, ts_depth2019_monthly, ts_depth2020_monthly, ts_depth2021_monthly, ts_depth2022_monthly, ts_depth2023_monthly)
